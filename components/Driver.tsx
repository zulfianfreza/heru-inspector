...
export default function Driver() {
    return (
        <section>
            <div className="mx-5 lg:mx-10 flex flex-col lg:flex-row mt-[60px] items-center">
                <div className="flex-1 p-5 lg:p-10 w-full flex justify-center">
                    <div className=" relative w-full sm:w-[608px] h-[286px] sm:h-[410px]">
                        <Image
                            src="/car.png"
                            fill={true}
                            alt=""
                ...
                <div className="flex-1 bg-yankess p-5 lg:px-[30px] lg:py-[50px] space-y-[15px]">
                    <h1 className=" text-white text-[36px] lg:text-[64px]">
                        Butuh Jasa Driver ?{" "}
                    ...
                    <button className=" gap-x-[15px] w-full py-[10px] flex items-center px-[20px] bg-white rounded-full">
                        ...
                        <h1 className=" text-[16px] font-medium lg:text-[48px]">
                            Hubungi Heru Driver
                        </h1>
                    </button>
                </div>
